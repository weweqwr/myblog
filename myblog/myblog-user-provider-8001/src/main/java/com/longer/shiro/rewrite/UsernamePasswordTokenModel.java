...
public class UsernamePasswordTokenModel implements AuthenticationToken {
     ...
     */
    public UsernamePasswordTokenModel(final String username, final char[] password) {
     ...
     */
    public UsernamePasswordTokenModel(final String username, final String password) {
        this(username, password != null ? password.toCharArray() : null, false, null);
    }
    public UsernamePasswordTokenModel(final String username, final String password,int roleid) {
        this(username, password != null ? password.toCharArray() : null, false, null);
        this.roleid=roleid;
    }
    /**
     ...
     * @since 0.2
     */
    public UsernamePasswordTokenModel(final String username, final char[] password, final String host) {
     ...
     * @since 1.0
     */
    public UsernamePasswordTokenModel(final String username, final String password, final String host) {
     ...
     * @since 0.9
     */
    public UsernamePasswordTokenModel(final String username, final char[] password, final boolean rememberMe) {
     ...
     * @since 0.9
     */
    public UsernamePasswordTokenModel(final String username, final String password, final boolean rememberMe) {
