...
//        maps.put("rememberMe", new RemberMeFilter());
        ...
        map.put("/article/selectArticle", "anon");
        map.put("/commentReply/selectCommentReply/**", "anon");
        map.put("/article/updateArticleBrowseAddById", "anon");
        map.put("/ueditor/ueditor", "anon");
        map.put("/ueditor/ueditorImageUpload", "anon");
        map.put("/**", "authc");
        // 未授权的跳转页
